...
<?php $has_header ? get_header() : wp_head(); ?>
    ...
    <div id="ilgl-password-modal" class="ilgl-password-modal" style="display: none;">
        <div class="ilgl-password-modal-content">
            <p><?= esc_html__('Please enter the password to continue:', 'intelligent-link') ?></p>
            <input type="password" id="ilgl-password-input" class="ilgl-password-input" placeholder="<?= esc_attr__('Enter password', 'intelligent-link') ?>" />
            <div class="ilgl-password-buttons">
                <button id="ilgl-password-submit" class="ilgl-password-submit"><?= esc_html__('Continue', 'intelligent-link') ?></button>
                <button id="ilgl-password-cancel" class="ilgl-password-cancel"><?= esc_html__('Cancel', 'intelligent-link') ?></button>
            </div>
            <div id="ilgl-password-error" class="ilgl-password-error" style="display: none;"><?= esc_html__('Incorrect password. Please try again.', 'intelligent-link') ?></div>
        </div>
    </div>
